...
UNIT_TESTING_NAME = tickrunit
CONTRACT_TESTING_NAME = tickrcontract
INTEGRATION_TESTING_NAME = tickrintegration
COMPONENT_TESTING_NAME = tickrcomponent
END_TO_END_TESTING_NAME = tickre2e
